...
import getRelatedListRecords from '@salesforce/apex/ConfigurableListController.getRelatedListRecords';
import getChildObjectInfo from '@salesforce/apex/ConfigurableListController.getChildObjectInfo';
import doesUserHavePermission from '@salesforce/apex/GetRecordsController.doesUserHavePermission';
import doQuery from '@salesforce/apex/GetRecordsController.doQuery';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { updateRecord } from 'lightning/uiRecordApi';
import USER_ID from '@salesforce/user/Id';

export default class ConfigurableList extends LightningElement {
    ...
    assignQueriedRecordsToJsObject(records) {
        ...
        if(this.relatedListRecords.length > 0){
            ...
            .then(result => {
                ...
                this.getUserPermission("Configurable_List_User");
